<template>
  <div class="container admin-security">
    <div class="row">
      ...
      <div class="col-12 col-md-11 offset-md-1 offset-xl-0  col-lg-7 admin-left-side mb-5">
        <div class="box">
          ...
          <div class="body-box border-bottom">
            <div class="title">
              <p class="param tr-gray-three">GREEN BLOCK CREATION</p>
            </div>
            <div class="main w-100 d-flex">
              <form class="form-group">
                ...
                <button class="btn-green">Lock</button>
              </form>
            </div>
          </div>
          <div class="body-box border-bottom">
            <div class="title">
              <p class="param tr-gray-three">TREE SUBMISSION</p>
            </div>
            <div class="main w-100 d-flex">
              <form class="form-group">
                <label for="current_price" class="first-input param tr-gray-two"
          ...
          <div class="body-box border-bottom">
            <div class="title">
              <p class="param tr-gray-three">O1 SUPPLY</p>
            </div>
            <div class="main w-100 d-flex">
              <form class="form-group">
                <label for="current_price" class="first-input param tr-gray-two"
      ...
      <div class="col-12 col-md-11 offset-md-1 offset-lg-0 col-lg-4 admin-left-side mb-5 admin-right-side">
        <div class="box">
