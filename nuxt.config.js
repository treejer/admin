...
export default {
  ...
  head: {
    ...
    meta: [
      ...
      {hid: 'og:site_name', property: 'og:site_name', content: 'Treejer Admin'},


      {hid: 'og:title', property: 'og:title', content: 'Treejer Admin | Planters Without Borders'},
      {hid: 'og:description', name: 'og:description', content: 'Treejer Admin'},
      {hid: 'og:url', property: 'og:url', content: 'https://treejer.com' },
      {hid: 'og:image', property: 'og:image', content: 'https://admin.treejer.com/featureImage/jake-hills.jpg'},

      {hid: 'twitter:card', property: 'twitter:card', content: 'summary_large_image'},
      {hid: 'twitter:title', property: 'twitter:title', content: 'Treejer Admin'},
